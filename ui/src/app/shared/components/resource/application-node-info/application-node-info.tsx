...
import {ClipboardText, Cluster} from '../../../components';
import {YamlEditor} from '../../../components/yaml-editor/yaml-editor';
import {DeepLinks} from '../../../components/deep-links';
import {lazyWithBoundary} from '../../../components/lazy-with-boundary';
import {Context} from '../../../context';
import * as models from '../../../models';
import {services} from '../../../services';
import type {ResourceTreeNode} from '../application-resource-tree/application-resource-tree';
import {ComparisonStatusIcon, formatCreationTimestamp, getAppUrl, getPodReadinessGatesState, getPodStateReason, HealthStatusIcon, nodeKey} from '../../resource-helpers';
...
export const ApplicationNodeInfo = (props: {
    ...
    readonly?: boolean;
    // readOnlyGeneratedApplication indicates the node is an Application generated by an ApplicationSet. In this
    ...
    if (props.readOnlyGeneratedApplication && props.live && props.live.status) {
