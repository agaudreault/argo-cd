...
export const ApplicationsContainer = (props: RouteComponentProps<any>) => {
    return (
        <Switch>
            ...
            <Route exact={true} path={`${props.match.path}/:name`} render={routeProps => <ApplicationDetails {...(routeProps as any)} />} />
            <Route exact={true} path={`${props.match.path}/:appnamespace/:name`} render={routeProps => <ApplicationDetails {...(routeProps as any)} />} />
