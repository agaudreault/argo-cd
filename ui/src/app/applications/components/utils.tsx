...
import {ResourceTreeNode} from '../../shared/components/resource/application-resource-tree/application-resource-tree';
import {
    BASE_COLORS,
    createdOrNodeKey,
    ...
    selectPostfix,
    userMsgsList
} from '../../shared/components/resource-helpers';

// Re-export the kind-agnostic resource helpers (now living in shared/components/resource-helpers)
...
import {
    AnnotationKeyAppInstance,
    DefaultAppInstanceLabelKey,
    formatApplicationSetProgressiveSyncStep,
    getAppOfAppsParentRef,
    getApplicationParentRef,
    getApplicationSetOwnerRef,
    getAppSetConditionCategory,
    getAppSetHealthStatus,
    isAppNode,
    isAppSetNode,
    TrackingMethodLabel
} from '../../shared/applications/utils';

// Re-export shared Application/ApplicationSet helpers so existing importers of
// this module keep working while the implementation lives in shared/applications.
export {
    AnnotationKeyAppInstance,
    DefaultAppInstanceLabelKey,
    formatApplicationSetProgressiveSyncStep,
